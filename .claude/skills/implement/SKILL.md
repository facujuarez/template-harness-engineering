---
name: implement
description: Ejecuta las tasks del spec aprobado (o las tasks inline en L0) una por una, sin commits intermedios. Usar cuando el usuario pide /implement, o quiere avanzar la siguiente task pendiente de la issue activa.
---

**Fase:** 4 · **Rol invocado:** [implementer](../../../workflow/agents/implementer.md)
